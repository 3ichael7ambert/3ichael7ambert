...
//   // Function to dynamically add OilPainting canvas to each main section
//   function addOilPaintingToSections() {
//     var header = document.querySelector("header"); // Selecting the header element
//     var mainSections = document.querySelectorAll(
//       "#education, #resume, #certificates"
//     ); // Selecting sections by their IDs
//     mainSections.forEach(function (section) {
//       var canvasId = "art-canvas-" + section.id;
//       var canvas = document.createElement("canvas");
//       canvas.id = canvasId;
//       section.appendChild(canvas);
//       initializeOilPainting(canvasId);
//     });
//     // Adding canvas to the header
//     var canvasIdHeader = "art-canvas-header";
//     var canvasHeader = document.createElement("canvas");
//     canvasHeader.id = canvasIdHeader;
//     header.appendChild(canvasHeader);
//     initializeOilPainting(canvasIdHeader);
//   }

//   // Call the function to add OilPainting canvas to main sections
//   addOilPaintingToSections();
